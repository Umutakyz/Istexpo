...
@section('header', 'Fuar Yönetimi')

@section('content')
<div class="content-section">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px;">
        <h2 class="section-title">Tüm Fuarlar</h2>
            ...
            <tr>
                ...
                <td>
                    <div style="display: flex; gap: 16px;">
                        ...
                        <form action="{{ route('admin.fairs.destroy', $fair) }}" method="POST" onsubmit="return confirm('Emin misiniz?')">
                            @csrf
                            @method('DELETE')
