    ...
    <form action="{{ route('admin.fairs.update', $fair) }}" method="POST" enctype="multipart/form-data">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px; margin-bottom: 24px;">
            ...
            <div style="grid-column: span 2;">
                ...
                <input type="text" name="name" value="{{ $fair->name }}" required style="width: 100%; background: #0d1117; border: 1px solid var(--admin-border); padding: 12px 16px; border-radius: 12px; color: #fff; font-family: inherit; outline: none;">
            </div>
            ...
            <div>
                ...
                <input type="text" name="location" value="{{ $fair->location }}" required style="width: 100%; background: #0d1117; border: 1px solid var(--admin-border); padding: 12px 16px; border-radius: 12px; color: #fff; font-family: inherit; outline: none;">
            </div>
            ...
            <div>
                ...
                <input type="date" name="start_date" value="{{ $fair->start_date->format('Y-m-d') }}" required style="width: 100%; background: #0d1117; border: 1px solid var(--admin-border); padding: 12px 16px; border-radius: 12px; color: #fff; font-family: inherit; outline: none;">
            </div>

            <div>
                <label style="display: block; font-size: 13px; font-weight: 700; color: var(--admin-text-muted); margin-bottom: 8px;">Bitiş Tarihi</label>
                <input type="date" name="end_date" value="{{ $fair->end_date->format('Y-m-d') }}" required style="width: 100%; background: #0d1117; border: 1px solid var(--admin-border); padding: 12px 16px; border-radius: 12px; color: #fff; font-family: inherit; outline: none;">
            </div>

            <div style="grid-column: span 2;">
                <label style="display: block; font-size: 13px; font-weight: 700; color: var(--admin-text-muted); margin-bottom: 8px;">Açıklama</label>
                <textarea name="description" rows="5" style="width: 100%; background: #0d1117; border: 1px solid var(--admin-border); padding: 12px 16px; border-radius: 12px; color: #fff; font-family: inherit; outline: none; resize: vertical;">{{ $fair->description }}</textarea>
            </div>
            ...
            <div>
                ...
                <input type="text" name="subject" value="{{ $fair->subject }}" style="width: 100%; background: #0d1117; border: 1px solid var(--admin-border); padding: 12px 16px; border-radius: 12px; color: #fff; font-family: inherit; outline: none;">
            </div>
            ...
            <div>
                ...
                <input type="text" name="venue" value="{{ $fair->venue }}" style="width: 100%; background: #0d1117; border: 1px solid var(--admin-border); padding: 12px 16px; border-radius: 12px; color: #fff; font-family: inherit; outline: none;">
            </div>

            <div>
                <label style="display: block; font-size: 13px; font-weight: 700; color: var(--admin-text-muted); margin-bottom: 8px;">Organizatör</label>
                <input type="text" name="organizer" value="{{ $fair->organizer }}" style="width: 100%; background: #0d1117; border: 1px solid var(--admin-border); padding: 12px 16px; border-radius: 12px; color: #fff; font-family: inherit; outline: none;">
            </div>
            ...
            <div>
                ...
                <input type="text" name="edition" value="{{ $fair->edition }}" style="width: 100%; background: #0d1117; border: 1px solid var(--admin-border); padding: 12px 16px; border-radius: 12px; color: #fff; font-family: inherit; outline: none;">
            </div>
            ...
            <div>
                ...
                <input type="text" name="grant_amount" value="{{ $fair->grant_amount }}" style="width: 100%; background: #0d1117; border: 1px solid var(--admin-border); padding: 12px 16px; border-radius: 12px; color: #fff; font-family: inherit; outline: none;">
            </div>

            <div>
                <label style="display: block; font-size: 13px; font-weight: 700; color: var(--admin-text-muted); margin-bottom: 8px;">Web Sitesi</label>
                <input type="url" name="website" value="{{ $fair->website }}" style="width: 100%; background: #0d1117; border: 1px solid var(--admin-border); padding: 12px 16px; border-radius: 12px; color: #fff; font-family: inherit; outline: none;" placeholder="https://...">
            </div>
            ...
            <div style="grid-column: span 2;">
                ...
                <textarea name="exhibitor_profile" rows="5" style="width: 100%; background: #0d1117; border: 1px solid var(--admin-border); padding: 12px 16px; border-radius: 12px; color: #fff; font-family: inherit; outline: none; resize: vertical;">{{ $fair->exhibitor_profile }}</textarea>
            </div>
        </div>
